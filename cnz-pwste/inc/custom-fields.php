...
if( ! class_exists( 'CNZ_Theme_Custom_Fields' ) ) :

	class CNZ_Theme_Custom_Fields {
		...
		public function register_post_meta() {   
		    ...
		    add_meta_box( 'sidebar_position_metabox', esc_html__( 'Sidebar Position', 'cnz-pwste' ), array( $this, 'sidebar_position_meta' ), array( 'post', 'page' ), 'side', 'default' );
		}
		...
		public function sidebar_position_meta() {
			...
			$sidebar_position_key = 'cnz_sidebar_position';
		    ...
		    $choices = array(
		        ...
		        'none' => esc_html__( 'Fullwidth', 'cnz-pwste' ),
		    );
		...
		public function save_sidebar_position_meta() {
		    ...
		    if( isset( $_POST['sidebar_position'] ) ) {
				...
				update_post_meta( $post->ID, 'cnz_sidebar_position', sanitize_text_field( wp_unslash( $_POST['sidebar_position'] ) ) ); 
			}
		}
	}
endif;

$cnz_custom_fields = new CNZ_Theme_Custom_Fields();