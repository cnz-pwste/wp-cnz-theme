...
if( ! class_exists( 'CNZ_Theme_Sortable_Repeater_Control' ) ) {

	class CNZ_Theme_Sortable_Repeater_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'cnz-pwste-sortable-repeater', get_template_directory_uri() . '/customizer/assets/js/sortable-repeater.js', array( 'jquery', 'jquery-ui-core' ), CNZ_THEME_VERSION, true );

			wp_enqueue_style( 'cnz-pwste-sortable-repeater', get_template_directory_uri() . '/customizer/assets/css/sortable-repeater.css' );
		}
