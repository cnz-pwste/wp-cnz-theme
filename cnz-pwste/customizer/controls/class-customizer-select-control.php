...
if( ! class_exists( 'CNZ_Theme_Select_Control' ) ) {

	class CNZ_Theme_Select_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'select2', get_template_directory_uri() . '/customizer/assets/js/select2.js', array( 'jquery' ), CNZ_THEME_VERSION, true );

			wp_enqueue_script( 'cnz-pwste-select', get_template_directory_uri() . '/customizer/assets/js/select.js', array( 'jquery' ), CNZ_THEME_VERSION, true );

			wp_enqueue_style( 'select2', get_template_directory_uri() . '/customizer/assets/css/select2.css' );

			wp_enqueue_style( 'cnz-pwste-select', get_template_directory_uri() . '/customizer/assets/css/select.css' );
		}
