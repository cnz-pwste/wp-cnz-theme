...
if( ! class_exists( 'CNZ_Theme_Radio_Image_Control' ) ) {

    class CNZ_Theme_Radio_Image_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            ...
            wp_enqueue_style( 'cnz-pwste-radio-image', get_template_directory_uri() . '/customizer/assets/css/radio-image.css' );
        }
