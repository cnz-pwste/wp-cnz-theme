(function($) {
    ...
    $(document).ready(function() {
        ...
        */
        ...
        if (cnz_obj.added_to_cart_message) {

            $(document.body).on('added_to_cart', function() {

                iziToast.success({

                    message: cnz_obj.added_to_cart_message,
        ...
        if (cnz_obj.cart_updated_message) {

            $(document.body).on('updated_cart_totals', function() {

                iziToast.info({

                    message: cnz_obj.cart_updated_message,

                });
            });
        }

        if (cnz_obj.removed_from_cart_message) {

            $(document.body).on('removed_from_cart', function() {

                iziToast.success({

                    message: cnz_obj.removed_from_cart_message,
        ...
        */
        ...
        // Count & add class in Mega Menu CNZ Theme
        ...
        */
        ...
        var mobile_products_col = cnz_obj.product_cols_on_mobile;
        ...
        */
        ...
        $('body').on('click', ".cnz-backtotop", function(event) {
        ...
        if( cnz_obj.scroll_top == '1' ) {
            ...
            $(window).scroll(function() {
                ...
                if (height > 600) {
                    ...
                    $('.cnz-backtotop').fadeIn('slow');

                } else {

                    $('.cnz-backtotop').fadeOut('slow');
                }
            });    
        }   
