...
if( ! class_exists( 'CNZ_Theme_Advertisement_Widget' ) ) :

    class CNZ_Theme_Advertisement_Widget extends WP_Widget {
 
        function __construct() { 

            parent::__construct(
                'cnz-pwste-advertisement-widget',
                esc_html__( 'OS: Offer Advertisement', 'cnz-pwste' ),
                array(
                    'classname' => '',
                    'description' => esc_html__( 'Displays offer advertisement.', 'cnz-pwste' ), 
                )
            );
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('show_offer_contents') ); ?>">
                    ...
                    <strong><?php esc_html_e('Display Offer Contents', 'cnz-pwste'); ?></strong>
                </label>
                ...
                <span class="<?php echo esc_attr( $wrapper_class ); ?>">
                    <label for="<?php echo esc_attr( $this->get_field_id('offer_title') ); ?>">
                        <strong><?php esc_html_e('Offer Title', 'cnz-pwste'); ?></strong>
                    </label>
                    ...
                    <label for="<?php echo esc_attr( $this->get_field_id('offer_text') ); ?>">
                        <strong><?php esc_html_e('Offer Text', 'cnz-pwste'); ?></strong>
                    </label>
                    ...
                    <label for="<?php echo esc_attr( $this->get_field_id('content_alignment') ); ?>">
                        <strong><?php esc_html_e('Content Alignment', 'cnz-pwste'); ?></strong>
                    </label>  
                    <?php
                    $alignments = array(
                        'left' => esc_html__( 'Left', 'cnz-pwste' ),
                        'center' => esc_html__( 'Center', 'cnz-pwste' ),
                        'right' => esc_html__( 'Right', 'cnz-pwste' ),
                    );
                    ?>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('offer_image')); ?>">
                    <strong><?php esc_html_e('Offer Image', 'cnz-pwste'); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('set_image_in_background') ); ?>">
                    ...
                    <strong><?php esc_html_e('Set Image In Background', 'cnz-pwste'); ?></strong>
                </label>
            </p> 
            <?php
        }
