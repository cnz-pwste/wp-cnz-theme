...
if( ! class_exists( 'CNZ_Theme_Featured_Product_Categories_Widget' ) ) {

    class CNZ_Theme_Featured_Product_Categories_Widget extends WP_Widget {
     
        function __construct() { 

            parent::__construct(
                'cnz-pwste-featured-product-categories-widget',
                esc_html__( 'OS: Featured Product Categories', 'cnz-pwste' ),
                array(
                    'classname'     => '',
                    'description'   => esc_html__( 'Displays featured product categories.', 'cnz-pwste' ), 
                )
            );     
        }
