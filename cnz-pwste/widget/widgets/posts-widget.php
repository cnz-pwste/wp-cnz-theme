...
if( ! class_exists( 'CNZ_Theme_Post_Widget' ) ) :

    class CNZ_Theme_Post_Widget extends WP_Widget {
 
        function __construct() { 

            parent::__construct(
                'cnz-pwste-post-widget',
                esc_html__( 'OS: Recent Blog Posts', 'cnz-pwste' ),
                array(
                    'description' => esc_html__( 'Displays posts.', 'cnz-pwste' ), 
                )
            );
        }
                                ...
                                if( $blog_posts->have_posts() ) {
                                        ...
                                        <div class="os-col blog-col">
                                            <div class="card wow osfadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                                <div class="thumb imghover">
                                                    <?php
                                                    /**
                                                    * Hook - cnz_large_thumbnail.
                                                    *
                                                    * @hooked cnz_large_thumbnail_action - 10
                                                    */
                                                    do_action( 'cnz_large_thumbnail' );
                                    ...
                                    <div class="col-12">
                                        <div class="nothing-found-title">
                                            <p><?php esc_html_e( 'There are no posts to display.', 'cnz-pwste' ); ?></p>
                                            <?php
                                            if( current_user_can( 'publish_posts' ) ) {
                                                printf(
                                                    '<p>' . wp_kses(
                                                        /* translators: 1: link to WP admin new post page. */
                                                        __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'cnz-pwste' ),
                                                        array(
                                                            'a' => array(
                                                                'href' => array(),
                                                            ),
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_name('no_of_posts') ); ?>">
                    <strong><?php esc_html_e('No of Posts', 'cnz-pwste'); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('show_excerpt') ); ?>">
                    ...
                    <strong><?php esc_html_e('Display Post Excerpt', 'cnz-pwste'); ?></strong>
                </label>
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('show_categories') ); ?>">
                    ...
                    <strong><?php esc_html_e('Display Post Categories', 'cnz-pwste'); ?></strong>
                </label>
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('show_author') ); ?>">
                    ...
                    <strong><?php esc_html_e('Display Post Author', 'cnz-pwste'); ?></strong>
                </label>
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('show_date') ); ?>">
                    ...
                    <strong><?php esc_html_e('Display Date', 'cnz-pwste'); ?></strong>
                </label>
            </p>           
            <?php
        }
