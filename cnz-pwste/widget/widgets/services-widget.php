...
if( ! class_exists( 'CNZ_Theme_Services_Widget' ) ) :

    class CNZ_Theme_Services_Widget extends WP_Widget {
 
        function __construct() { 

            parent::__construct(
                'cnz-pwste-services-widget',
                esc_html__( 'OS: Services', 'cnz-pwste' ),
                array(
                    'description' => esc_html__( 'Displays services.', 'cnz-pwste' ), 
                )
            );
                    ...
                    <span class="os-fields-wrapper">
                        <span class="os-fields-wrapper-title">
                            <strong>
                                ...
                                printf( esc_html__( 'Service %s', 'cnz-pwste' ), $i + 1 ); 
                                ?>
                            </strong>
                        ...
                        <span class="os-fields">
                            ...
                            <label for="<?php echo esc_attr( $this->get_field_id('services_descs') . $i ); ?>">
                                <strong><?php esc_html_e('Description', 'cnz-pwste'); ?></strong>
                            </label>
                            ...
                            <label for="<?php echo esc_attr($this->get_field_id('services_imgs') . $i ); ?>">
                                <strong><?php esc_html_e('Icon Image', 'cnz-pwste'); ?></strong>
                            </label>
                            <span class="os-image-notice"><?php esc_html_e( 'Upload image having 1x1 aspect ratio.', 'cnz-pwste' ); ?></span>
