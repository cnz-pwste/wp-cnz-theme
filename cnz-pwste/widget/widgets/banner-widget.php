...
if( ! class_exists( 'CNZ_Theme_Banner_Widget' ) ) {

    class CNZ_Theme_Banner_Widget extends WP_Widget {
     
        function __construct() { 

            parent::__construct(
                'cnz-pwste-banner-widget',
                esc_html__( 'OS: Banner', 'cnz-pwste' ),
                array(
                    'classname'     => '',
                    'description'   => esc_html__( 'Displays main slider', 'cnz-pwste' ), 
                )
            );     
        }
        ...
        public function form( $instance ) {
            ...
            <p>
                <span class="sldr-elmnt-title"><strong><?php esc_html_e( 'Slider Elements', 'cnz-pwste' ); ?></strong></span>

                <?php
                $page_choices = cnz_all_pages();
                    ...
                    <span class="os-fields-wrapper">
                        <span class="os-fields-wrapper-title">
                            <strong>
                                ...
                                printf( esc_html__( 'Slider Item %s', 'cnz-pwste' ), $i+1 );
                                ?>
                            </strong>
                            <span class="os-collapse-icon"><span class="dashicons dashicons-arrow-down"></span></span>
                        </span>
                        <span class="os-fields">
                            <label for="<?php echo esc_attr( $this->get_field_id( 'slider_pages' ) . $i ); ?>"><strong><?php esc_html_e( 'Select Page', 'cnz-pwste' ); ?></strong></label>
                            ...
                            <label for="<?php echo esc_attr( $this->get_field_id( 'button_titles' ) . $i ); ?>">
                                <strong><?php esc_html_e( 'Button Title', 'cnz-pwste' ); ?></strong>
                            </label>
                            <input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'button_titles' ) . $i ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'button_titles' ) ); ?>[]" value="<?php if( !empty( $instance['button_titles'][$i] ) ) { echo esc_attr( $instance['button_titles'][$i] ); } ?>">
                             ...
                             <label for="<?php echo esc_attr( $this->get_field_id( 'button_links' ) . $i ); ?>">
                                <strong><?php esc_html_e( 'Button Link', 'cnz-pwste' ); ?></strong>
                            </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('show_contents') ); ?>">
                    ...
                    <strong><?php esc_html_e( 'Show Slider Contents', 'cnz-pwste' ); ?></strong>
                </label>                 
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('enable_mask') ); ?>">
                    ...
                    <strong><?php esc_html_e( 'Enable Mask Layer', 'cnz-pwste' ); ?></strong>
                </label>                 
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id('banner_img_1')); ?>">
                    <strong><?php esc_html_e('Banner Image One', 'cnz-pwste'); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('banner_link_1') ); ?>">
                    <strong><?php esc_html_e( 'Banner Link One', 'cnz-pwste' ); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('banner_img_2')); ?>">
                    <strong><?php esc_html_e('Banner Image Two', 'cnz-pwste'); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('banner_link_2') ); ?>">
                    <strong><?php esc_html_e( 'Banner Link Two', 'cnz-pwste' ); ?></strong>
                </label>
