...
if( ! class_exists( 'CNZ_Theme_About_Widget' ) ) {

	class CNZ_Theme_About_Widget extends WP_Widget {

		function __construct() { 

            parent::__construct(

                'cnz-pwste-about-widget',
                esc_html__( 'OS: About Widget', 'cnz-pwste' ),
                array(
                    'classname'     => 'os-about-widget',
                    'description'   => esc_html__( 'Displays Store About Information', 'cnz-pwste' ), 
                )
            );     
        }
    	...
    	public function form( $instance ) {
            ...
            <p>
                <span class="os-fields-wrapper">
                    <span class="os-fields-wrapper-title">
                        <strong><?php esc_html_e( 'Store Information', 'cnz-pwste' ); ?></strong>
                    ...
                    <span class="os-fields">
                        <label for="<?php echo esc_attr($this->get_field_id('store_logo')); ?>">
                            <strong><?php esc_html_e('Logo', 'cnz-pwste'); ?></strong>
                        </label>
                        ...
                        <span class="os-image-uploader-container">
                            ...
                            <button class="<?php echo esc_attr( $upload_btn_class ); ?>" id="os-upload-btn"><?php esc_html_e( 'Upload', 'cnz-pwste' ); ?></button>
                            <button class="<?php echo esc_attr( $remove_btn_class ); ?>" id="os-remove-btn"><?php esc_html_e( 'Remove', 'cnz-pwste' ); ?></button>
                        </span>

                        <label for="<?php echo esc_attr( $this->get_field_name('store_description') ); ?>">
                            <strong><?php esc_html_e( 'Short Description', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('store_address') ); ?>">
                            <strong><?php esc_html_e( 'Address', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('store_phone') ); ?>">
                            <strong><?php esc_html_e( 'Contact Number', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('store_email') ); ?>">
                            <strong><?php esc_html_e( 'Email', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('store_opening_time') ); ?>">
                            <strong><?php esc_html_e( 'Opening Time', 'cnz-pwste' ); ?></strong>
                        </label>
            ...
            <p>
                <span class="os-fields-wrapper">
                    <span class="os-fields-wrapper-title">
                        <strong><?php esc_html_e( 'Social Links', 'cnz-pwste' ); ?></strong>
                        <span class="os-collapse-icon"><span class="dashicons dashicons-arrow-down"></span></span>
                    </span>

                    <span class="os-fields">
                        <label for="<?php echo esc_attr( $this->get_field_name('facebook_url') ); ?>">
                            <strong><?php esc_html_e( 'Facebook Link', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('twitter_url') ); ?>">
                            <strong><?php esc_html_e( 'Twitter Link', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('instagram_url') ); ?>">
                            <strong><?php esc_html_e( 'Instagram Link', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('pinterest_url') ); ?>">
                            <strong><?php esc_html_e( 'Pinterest Link', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('youtube_url') ); ?>">
                            <strong><?php esc_html_e( 'YouTube Link', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('vimeo_url') ); ?>">
                            <strong><?php esc_html_e( 'Vimeo Link', 'cnz-pwste' ); ?></strong>
                        </label>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_name('vk_url') ); ?>">
                            <strong><?php esc_html_e( 'VK Link', 'cnz-pwste' ); ?></strong>
                        </label>
